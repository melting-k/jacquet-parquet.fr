...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	...
	<body>
		<header class="realisations">
			<nav>
				...
				---><ul id="menu">
					...
					---><li class="active"><a href="realisations-parquet-terrasse-toulouse.php" title="Nos réalisations sur la région toulousaine">RÉALISATIONS</a></li><!--
			...
			<div id="titre-page">
				<p class="center blanc">
					...
					<br/><br/>
					<span class="font46 alright-sb">Découvrez nos réalisations</span>
					<br/><br/><br/>
		...
		<section id="main-content">
			<div>
				<section>
						<h1 class="center">Les réalisations de Jacquet Parquet à Toulouse<br/><span></span></h1>
						<p class="center">
		...
		<footer>
			<div>
				<nav>
					...
					<a href="realisations-parquet-terrasse-toulouse.php" title="Nos réalisations sur la région toulousaine" class="active">RÉALISATIONS</a>
