...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	...
	<body>
		<header class="references">
			<nav>
				...
				---><ul id="menu">
					...
					---><li class="active"><a href="references-et-clients-baptiste-jacquet.php" title="Nos principales références et clients">RÉFÉRENCES</a></li><!--
			...
			<div id="titre-page">
				<p class="center blanc">
					...
					<br/><br/>
					<span class="font46 alright-sb">Découvrez nos références</span>
					<br/><br/><br/>
					<a href="pose-renovation-parquet-toulouse.php" title="Pose et rénovation de parquet" class="bouton">NOS PARQUETS</a>
		...
		<section id="main-content">
			<div>
				<section>
						<h1 class="center">Nos références et clients à Toulouse et en Haute-Garonne<br/><span></span></h1>
						<p class="center references">
							Découvrez ci-dessous quelques unes de nos références dans la région Toulousaine, n’hésitez pas à nous contacter pour<br/>
							toute demande d’informations complémentaires.
							<br/><br/><br/>
							<img src="images/references/borriquito.jpg" alt="Borriquito Loco" class="middle"/>
							<img src="images/references/holiday-inn.jpg" alt="Holiday Inn" class="middle"/>
							<img src="images/references/tnt.jpg" alt="TNT" class="middle"/>
							<img src="images/references/el-divino.jpg" alt="El Divino" class="middle"/>
							<img src="images/references/serge-blanco.jpg" alt="Serge Blanco" class="middle"/>
							<br/><br/>
							<img src="images/references/case4you.jpg" alt="Case 4 you" class="middle"/>
		...
		<footer>
			<div>
				<nav>
					...
					<a href="references-et-clients-baptiste-jacquet.php" title="Nos principales références et clients" class="active">RÉFÉRENCES</a>
