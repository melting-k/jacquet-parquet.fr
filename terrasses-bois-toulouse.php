		...
		<header class="terrasses">
			...
			<div id="titre-page">
				<p class="center blanc">
					...
					<br/><br/>
					<span class="font46 alright-sb">Pose & rénovation de parquet</span>
					<br/><br/><br/>
		...
		<section id="main-content">
			<div>
				...
				---><div class="column-small right">
						<p>
							<img src="images/terrasses-bois/terrasses-bois-toulouse.jpg" alt="Création de terrasses en bois" class="photo-fourniture"/>
						</p>
					</div>
				</section>
				<section>
					<div class="column-small left">
						<p>
							<img src="images/terrasses-bois/terrasses-piscine-toulouse.jpg" alt="PLages de piscines en bois à Toulouse"/>
						</p>
					</div><!--
				---><div class="column-big right">
						<h2>Une question ? Un devis ?<br/><span></span></h2>
						<p>
							Jacquet Parquet vous propose la gestion globale de votre projet de terrasse bois à Toulouse, ou tout aménagement autour d’une piscine ou espace extérieur. Pour toute demande de renseignements complémentaire ou d’estimation concernant la création de votre terrasse, n’hésitez pas à nous contacter.
							<br/><br/>
							Nous nous déplaçons chez vous pour établir un devis détaillé et personnalisé.
							<br/><br/>
		...
		<footer>
			<div>
				<nav>
					...
					<a href="terrasses-bois-toulouse.php" title="Création de terrasses en bois" class="active">TERRASSES</a>
