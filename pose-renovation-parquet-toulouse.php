...
Parce que l’on veut être sûr que le parquet sélectionné vous correspond, vous avez le choix entre de nombreuses finitions : vitrification, mise en teinte, application d’une peinture. Nous vous proposons un large choix de coloris et de rendus.<br/>
				...
				---><div class="column-small right">
						<p>
							<img src="images/pose-renovation/pose-parquet-toulouse.jpg" alt="Pose de parquet à Toulouse" class="photo-fourniture"/>
						</p>
					</div>
				</section>
				<section>
				...
				---><div class="column-small right">
						<p>
							<img src="images/pose-renovation/renovation-parquet-toulouse.jpg" alt="Rénovation de parquet à Toulouse"/>
						</p>
					</div>
				</section>
			</div>
		...
		<footer>
			<div>
				<nav>
					...
					<a href="pose-renovation-parquet-toulouse.php" title="Pose et rénovation de parquet" class="active">POSE & RÉNOVATION DE PARQUET</a>
