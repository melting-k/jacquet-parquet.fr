 ...
 * PHP Version 5.5.
 *
 * @see       https://github.com/PHPMailer/PHPMailer/ The PHPMailer GitHub projet
 *
...
class PHPMailer
{
     ...
     * $_SERVER['SERVER_NAME'], gethosttitle(), php_uname('n'), or the value
     ...
     *
     * @return bool `true` if functions for IDN support are present
     */
     ...
     * - Conversion to punycode is impossible (e.g. PHP functions are not available)
    ...
    {
        // Verify we have functions, CharSet, and at-sign.
        $pos = strrpos($address, '@');
    ...
    public function createHeader()
    {
        ...
        if ('' != $this->MessageID and preg_match('/^<.*@.*>$/', $this->MessageID)) {
            ...
            $this->lastMessageID = sprintf('<%s@%s>', $this->uniqueid, $this->serverHosttitle());
        }
     ...
     * @return string
     */
    protected function serverHosttitle()
    {
        $result = '';
        ...
        } elseif (function_exists('gethostname') and gethosttitle() !== false) {
            $result = gethosttitle();
